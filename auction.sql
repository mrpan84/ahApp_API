...
DROP TABLE IF EXISTS `ahpersonel`;
CREATE TABLE IF NOT EXISTS `ahpersonel` (
  `uid` int NOT NULL,
...
DROP TABLE IF EXISTS `auction_stock`;
CREATE TABLE IF NOT EXISTS `auction_stock` (
  `auction_stock_id` int NOT NULL AUTO_INCREMENT,
  `reg_number` int NOT NULL,
  `auction_id` int NOT NULL,
  PRIMARY KEY (`auction_stock_id`),
  UNIQUE KEY `reg_number` (`reg_number`,`auction_id`),
...
CREATE TABLE IF NOT EXISTS `bales` (
  `bale_id` int NOT NULL AUTO_INCREMENT,
  `reg_number` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bids` (
  ...
  `auction_stoc_id` int NOT NULL,
  `bid_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `amount` decimal(10,2) NOT NULL,
  PRIMARY KEY (`buyer_id`,`auction_stoc_id`),
  UNIQUE KEY `bid_id` (`bid_id`),
  KEY `auction_stoc_id` (`auction_stoc_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
